...
function WelcomePage() {
  return (
    <div className="flex min-h-screen flex-col bg-gradient-to-b from-blue-50 via-white to-gray-100">
      {/* Header Section */}
      <Navbar fluid className="sticky top-0 z-50 bg-blue-700 lg:!px-24">
        ...
        {/* <Button as={Link} to="/auth/sign-in" size="sm" color="light">
            Login
          </Button>
          <Button as={Link} to="/auth/sign-up" size="sm" color="light">
            Get Started
          </Button> */}
      ...
      {/* Hero Section */}
      <div className="flex flex-col items-center bg-gradient-to-r from-blue-300 via-white to-gray-100 px-4 py-16 text-center">
        <h1 className="text-4xl font-extrabold leading-tight text-gray-800 md:text-5xl">
          Welcome to the{" "}
          <span className="text-blue-700">LIPAN Members Portal</span>
        </h1>
      ...
      {/* <Footer. className="bg-gray-800 py-4">
        <div className="text-center text-sm text-gray-400">
          © 2024 LIPAN. Empowering literacy and development across Nigeria.
        </div>
      </Footer.> */}
      ...
      <Footer container>
        <div className="w-full text-center">
          ...
          <div className="w-full justify-between sm:flex sm:items-center sm:justify-between">
            {/* <div className=" rounded-xl h-14  my-6"> */}
