    ...
    <div className="py-16 px-6">
      <div className="max-w-5xl mx-auto text-center">
        ...
        <p className="mt-4 text-lg text-gray-600">
          Explore our literacy platform with flexible plans tailored to your
          needs. Start for free or go premium for an enhanced experience.
        </p>
      </div>
      ...
      <div className="mt-12 grid gap-8 sm:grid-cols-2 max-w-5xl mx-auto">
        ...
        <Card className="shadow-lg">
          ...
          <p className="text-center text-gray-600 mt-2">
            Perfect for individuals who want to start their literacy journey at
            no cost.
          </p>
          <div className="mt-6">
        ...
        <Card className="shadow-lg bg-gradient-to-r from-blue-500 to-blue-600 text-white">
          ...
          <p className="text-center mt-2">
            For avid learners who want to unlock the full potential of the
            platform.
          </p>
          <div className="mt-6">
            <ul className="space-y-4">
